package com.bookStore01.common.log;
...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* com.bookStore01.*.service.*.*(..)) or "
			+ "execution(* com.bookStore01.*.dao.*.*(..))")
	...
	@After("execution(* com.bookStore01.*.service.*.*(..)) or "
			+ "execution(* com.bookStore01.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* com.bookStore01.*.service.*.*(..)) or "
			+ "execution(* com.bookStore01.*.dao.*.*(..))")
